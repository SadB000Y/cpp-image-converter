    ...
    bool SaveJPEG(const Path & file, const Image & image)
    {
       ...
       */
        ...
        while (cinfo.next_scanline < cinfo.image_height) {
            ...
            {
                image_buffer[counter] = static_cast<JSAMPLE>(line[x].r);
                image_buffer[counter + 1] = static_cast<JSAMPLE>(line[x].g);
                image_buffer[counter + 2] = static_cast<JSAMPLE>(line[x].b);
                counter += 3;
            }
